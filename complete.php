  ...
  <div id="page">
    <div id="header">
      ...
      <ul class="navigation">
        ...
        <li> <a href="complete.php" class="active">Đã Hoàn Thành</a> </li>
...
//End Counter
            ...
            $rec_limit = 5;
            $sql = "SELECT count(\"seriesID\") FROM series WHERE finished = 1";
            ...
            $sql = "SELECT * FROM series WHERE finished = 1 ORDER BY lastupd DESC LIMIT $rec_limit OFFSET $offset";
            ...
            while($row = $result->fetch_row())
            {
              ...
              echo "<li>
                      <h2><a href=\"player.php?series=$row[0]\">$row[1]</a> <span>$row[6]</span> </h2>
                      <table>
                      <tr><td><a href=\"player.php?series=$row[0]\"><img class=\"preimg\" src=\"".$row[2]."\" alt=\"error\"></a></td></tr>
                      <tr><td class=\"caption\"><p>$row[3]</p><p class=\"mems\">Trans: ";
              ...
              $sql = "SELECT epnum FROM ep WHERE seriesID = $row[0] ORDER BY epnum";
              $epresult = mysqli_query($con, $sql);
              echo "<p class=\"episode\">
              <span class=\"epnum\"> Tập số: </span>";
              while($epnum = $epresult->fetch_row()){
              echo "<span class=\"epnum\"> <a href=\"player.php?series=$row[0]&ep=$epnum[0]\">$epnum[0]</a> </span>";
              }
              echo "</p><br>";
