  ...
  <div id="page">
    <div id="header">
      ...
      <ul class="navigation">
        ...
        <li> <a href="ongoing.php" class="active">Đang Dịch</a> </li>
...
//End Counter
            ...
            $rec_limit = 5;
            $sql = "SELECT count(\"seriesID\") FROM series WHERE finished = 0";
            ...
            $sql = "SELECT * FROM series WHERE finished = 0 ORDER BY lastupd DESC LIMIT $rec_limit OFFSET $offset";
